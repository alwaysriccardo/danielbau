              ...
              >
                {projects[selectedProjectIndex] && (
                  <>
                    ...
                    {/* Project Gallery - Simplified Professional Grid */}
                    {projects[selectedProjectIndex].media.length > 0 ? (
                      <div className="w-full max-w-7xl mx-auto">
                        {/* Determine grid layout based on media count */}
                        {(() => {
                          const mediaCount = projects[selectedProjectIndex].media.length;
                          let gridCols = '';
                          let maxWidth = '';
                          
                          if (mediaCount === 1) {
                            // Single media: moderate size, centered
                            ...
                            // Three media: 2+1 or 3 columns
                            gridCols = 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3';
                            maxWidth = 'max-w-6xl';
                          } else {
                            // Four or more: standard grid
                              ...
                              <div className={`grid ${gridCols} gap-4 md:gap-6`}>
                                {projects[selectedProjectIndex].media.map((media) => (
                                  ...
                                  >
                                    ...
                                    {/* Media captions - only show if there's content */}
                                    {(media.title || media.description) && (
