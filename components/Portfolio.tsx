        ...
        {projects.length > 0 ? (
          <div>
            ...
            {isAdmin ? (
              ...
              // Public view: Clean, simple, professional design
              <div 
              ...
              >
                {projects[selectedProjectIndex] && (
                  <>
                    {/* Project Navigation - Minimal & Clean */}
                    {projects.length > 1 && (
                      <div className="flex items-center justify-between mb-8 md:mb-12 max-w-6xl mx-auto px-4">
                        <button
                          onClick={(e) => {
                            e.preventDefault();
                            e.stopPropagation();
                    ...
                    {/* Project Header - Clean Typography */}
                    <div className="mb-8 md:mb-12 text-center max-w-4xl mx-auto px-4">
                      {editingProjectNameInline === projects[selectedProjectIndex].id ? (
                        <div className="flex items-center justify-center gap-2 mb-4">
                          <input
                            ...
                            value={inlineProjectNameValue}
                            onChange={(e) => setInlineProjectNameValue(e.target.value)}
                            className="font-display text-2xl md:text-4xl text-gray-800 px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-[#121212] text-center"
                            autoFocus
                            onKeyDown={(e) => {
                              if (e.key === 'Enter') {
                        ...
                        <div className="flex items-center justify-center gap-2 mb-6">
                          <h2 className="font-display text-3xl md:text-5xl text-gray-900 font-normal">
                          ...
                          {isAdmin && (
                            <button
                              ...
                              className="p-1 text-gray-400 hover:text-[#121212] transition-colors"
                      ...
                      {projects[selectedProjectIndex].description && (
                        <div className="flex items-center justify-center gap-2">
                          {editingDescriptionInline === projects[selectedProjectIndex].id ? (
                            <div className="flex items-start gap-2 w-full max-w-2xl">
                              <textarea
                                ...
                                onChange={(e) => setInlineDescriptionValue(e.target.value)}
                                rows={3}
                                className="flex-1 px-4 py-2 text-base border border-gray-300 rounded focus:outline-none focus:border-[#121212] resize-none"
                          ...
                          {isAdmin && !editingDescriptionInline && (
                            <button
                    ...
                    {/* Media Grid - Simple & Professional */}
                    {projects[selectedProjectIndex].media.length > 0 ? (
                      <div className="max-w-7xl mx-auto px-4">
                        <div className={`grid gap-4 md:gap-6 ${
                          ...
                          {projects[selectedProjectIndex].media.map((media) => (
                            <div
                              key={media.id}
                      ...
                      <div className="min-h-[300px] flex items-center justify-center text-gray-400">
                        <p className="text-base">No media in this project yet</p>
                      </div>
                    )}
                  </>
                )}
